...
| P1-USER-4 | 通知列表            | \[API] GET /app/front-hub/notifications | 200                             |      |
...
| 编号  | 描述                                                                                                                                         | 状态 |
| ----- | -------------------------------------------------------------------------------------------------------------------------------------------- | ---- |
| S8-16 | 聊天链路收尾：气泡渲染 / 流式回复 / 刷新持久化全 PASS；\[call\_llm] 错误已修复（batch 未知列过滤 + controller results 信封，31a750c 已上线） | 完成 |
