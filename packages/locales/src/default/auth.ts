export default {
  ...
  'tab.apikey': 'API Key',
  'tab.developerUsage': 'Developer Usage',
  ...
  'harness.title': 'Harness Coding Agent',
  'harness.sessions': 'Sessions',
  'harness.newSession': 'New Session',
  'harness.empty': 'No sessions',
  'harness.chatEmpty': 'Describe a task to start, e.g. create /hello.txt with a greeting',
  'harness.running': 'Working',
  'harness.placeholder': 'Describe a task, e.g. read /src/main.ts and optimize it',
  'harness.send': 'Send',
  'harness.stop': 'Stop',
  'harness.toolCall': 'Tool call',
  'harness.approval': '⚠ Dangerous operation pending approval (see HITL approval center)',
  'harness.files': 'Files',
  'harness.editor': 'Editor',
  'harness.noFile': 'Select a file to view',
  'harness.save': 'Save',
  'harness.delete': 'Delete',
  'harness.deleted': 'Deleted',
  'harness.saved': 'Saved',
  'harness.created': 'Session created',
  'harness.deleteConfirm': 'Delete this session? Its files and command history will also be removed',
  'harness.deleteFileConfirm': 'Delete this file?',
  'harness.terminal': 'Terminal',
  'harness.terminalEmpty': 'No command output',
  'harness.runtime': 'Runtime',
  'harness.cloudRuntime': 'Cloud',
  'harness.localRuntime': 'Local',
  'harness.chooseWorkspace': 'Choose local code directory',
  'harness.workspace': 'Workspace',
  'harness.permission': 'Permission',
  'harness.workspaceWrite': 'Workspace Write',
  'harness.readOnly': 'Read Only',
  'harness.fullAccess': 'Full Access',
  'harness.executingTool': '⏳ Running {{tool}} on this machine…',
  'harness.approveTitle': 'Approve dangerous operation',
  'harness.approveConfirm': 'Approve',
  'harness.approveReject': 'Reject',
  'harness.deleteNeedsApproval': 'Deleting files requires AI approval — ask the AI to delete it in the chat',
  'harness.switchWorkspace': 'Switch directory',
  'harness.removeWorkspace': 'Remove',
  'teams.list': 'My Teams',
  'teams.create': 'Create Team',
  'teams.created': 'Team created',
  'teams.name': 'Team Name',
  'teams.description': 'Description',
  'teams.supervisorPrompt': 'Supervisor Prompt',
  'teams.supervisorPlaceholder': 'e.g. You are the lead, split tasks and summarize',
  'teams.members': 'Members',
  'teams.maxMembers': 'Max 5',
  'teams.memberName': 'Member name',
  'teams.memberRole': 'Role (optional)',
  'teams.memberPrompt': 'System prompt (optional)',
  'teams.addMember': 'Add Member',
  'teams.memberRequired': 'At least one member required',
  'teams.empty': 'Select a team',
  'teams.selectHint': 'Select a team on the left, or create one',
  'teams.runTitle': 'Run Workspace',
  'teams.taskPlaceholder': 'Describe a task, e.g. write an ad for a smart water dispenser',
  'teams.run': 'Run',
  'teams.runHint': 'Enter a task and click run to watch members work',
  'teams.summary': 'Final Summary',
  'teams.history': 'Run History',
  'teams.noHistory': 'No runs yet',
  'teams.deleteConfirm': 'Delete this team? Its run history will also be removed',
  'hitl.title': 'HITL Approval Center',
  'hitl.all': 'All',
  'hitl.tool': 'Tool',
  'hitl.args': 'Args',
  'hitl.description': 'Description',
  'hitl.risk': 'Risk',
  'hitl.status': 'Status',
  'hitl.actions': 'Actions',
  'hitl.approve': 'Approve',
  'hitl.reject': 'Reject',
  'hitl.decided': 'Processed',
  'hitl.createdAt': 'Created At',
  'hitl.empty': 'No approvals',
  'hitl.policies': 'Policies',
  'hitl.policyPlaceholder': 'Tool name, e.g. file_write',
  'hitl.addPolicy': 'Add Policy',
  'hitl.forceOn': 'Force Approval',
  'hitl.forceOff': 'Default Policy',
  'knowledge.bases': 'My Knowledge Bases',
  'knowledge.create': 'Create Base',
  'knowledge.name': 'Base Name',
  'knowledge.description': 'Description',
  'knowledge.empty': 'Select a base',
  'knowledge.selectHint': 'Select a base on the left, or create one',
  'knowledge.uploadHint': 'Click or drag files to upload (auto chunk + embed)',
  'knowledge.uploaded': 'Uploaded, indexing...',
  'knowledge.searchPlaceholder': 'Ask a question for semantic search',
  'knowledge.search': 'Search',
  'knowledge.docs': 'Documents',
  'knowledge.noDocs': 'No documents',
  'knowledge.results': 'Search Results',
  'workspace.title': 'Workspace',
  'workspace.statsTotal': 'Total',
  'workspace.statsRunning': 'Running',
  'workspace.statsCompleted': 'Completed',
  'workspace.statsFailed': 'Failed',
  'workspace.tasksTab': 'Tasks',
  'workspace.artifactsTab': 'Artifacts',
  'workspace.all': 'All',
  'workspace.newTask': 'New Task',
  'workspace.newArtifact': 'New Artifact',
  'workspace.noTasks': 'No tasks',
  'workspace.noArtifacts': 'No artifacts',
  'workspace.typeFilterPlaceholder': 'Filter by type',
  'workspace.taskTitle': 'Title',
  'workspace.status': 'Status',
  'workspace.progress': 'Progress',
  'workspace.createdAt': 'Created',
  'workspace.updatedAt': 'Updated',
  'workspace.actions': 'Actions',
  'workspace.viewDetail': 'View',
  'workspace.delete': 'Delete',
  'workspace.artifactTitle': 'Title',
  'workspace.type': 'Type',
  'workspace.subtype': 'Subtype',
  ...
  'workspace.relatedArtifacts': 'Artifacts',
  'workspace.logs': 'Logs',
  'workspace.noLogs': 'No logs',
  'workspace.artifactDetail': 'Artifact Detail',
  'workspace.content': 'Content',
  'workspace.downloadCurrent': 'Download Current',
  'workspace.versions': 'Versions',
  'workspace.version': 'Version',
  'workspace.source': 'Source',
  'workspace.changeLog': 'Change Log',
  'workspace.diffTitle': 'Diff',
  'workspace.viewDiff': 'View Diff',
  'workspace.deleteTaskConfirm': 'Delete this task?',
  'workspace.deleteArtifactConfirm': 'Delete this artifact?',
  'workspace.deleted': 'Deleted',
  'workspace.taskCreated': 'Task created',
  'workspace.artifactCreated': 'Artifact created',
  'market.title': 'Agent Marketplace',
  'market.all': 'All',
  'market.clone': 'Clone',
  'market.cloned': 'Cloned to my agents',
  'market.rated': 'Rated',
  'market.empty': 'No listings',
  'market.mine': 'My Listings',
  'developer.tokens.name': 'Name',
  'developer.tokens.namePlaceholder': 'e.g. my production key',
  'developer.tokens.key': 'Key',
  'developer.tokens.expiresAt': 'Expires',
  'developer.tokens.neverExpires': 'Never expires',
  'developer.tokens.usage': 'Usage / Quota',
  'developer.tokens.status': 'Status',
  'developer.tokens.status.active': 'Active',
  'developer.tokens.status.disabled': 'Disabled',
  'developer.tokens.status.expired': 'Expired',
  'developer.tokens.actions': 'Actions',
  'developer.tokens.empty': 'No API keys',
  'developer.tokens.loadError': 'Failed to load API keys',
  'developer.tokens.create': 'Create API Key',
  'developer.tokens.createTitle': 'Create API Key',
  'developer.tokens.resultTitle': 'API Key',
  'developer.tokens.copied': 'API Key copied to clipboard',
  'developer.tokens.onceOnly': 'This key is shown only once. Copy it now — it cannot be retrieved later.',
  'developer.tokens.copy': 'Copy',
  'developer.tokens.done': 'Done',
  'developer.tokens.cancel': 'Cancel',
  'developer.tokens.rotate': 'Rotate',
  'developer.tokens.rotateConfirm': 'Rotating invalidates the current key immediately. Continue?',
  'developer.tokens.delete': 'Delete',
  'developer.tokens.deleteConfirm': 'Delete this API key? Requests using it will fail immediately.',
  'developer.tokens.deleted': 'API Key deleted',
  'developer.usage.monthRequests': "This Month's Requests",
  'developer.usage.monthSpend': "This Month's Spend",
  'developer.usage.balance': 'Balance',
  'developer.usage.dailyTrend': 'Daily Trend',
  'developer.usage.perKey': 'Per-Key Details',
  'developer.usage.key': 'Key',
  'developer.usage.last4': 'Key Suffix',
  'developer.usage.requests': 'Requests',
  'developer.usage.tokens': 'Tokens',
  'developer.usage.spend': 'Spend',
  'developer.usage.empty': 'No usage data',
  'developer.usage.loadError': 'Failed to load usage',
  'developer.webhooks.url': 'URL',
  'developer.webhooks.urlInvalid': 'URL must start with https://',
  'developer.webhooks.events': 'Events',
  'developer.webhooks.secret': 'Signing Secret',
  'developer.webhooks.secretPlaceholder': 'Optional HMAC signing secret',
  'developer.webhooks.create': 'Create Webhook',
  'developer.webhooks.created': 'Webhook created',
  'developer.webhooks.deleted': 'Webhook deleted',
  'developer.webhooks.deleteConfirm': 'Delete this webhook?',
  'developer.webhooks.enabled': 'Enabled',
  'developer.webhooks.lastStatus': 'Last Status',
  'developer.webhooks.never': 'Never',
  'developer.webhooks.test': 'Send Test',
  'developer.webhooks.testSent': 'Test event sent',
  'developer.webhooks.redeliver': 'Redeliver',
  'developer.webhooks.redelivered': 'Redeliver requested',
  'developer.webhooks.empty': 'No webhooks',
  'developer.webhooks.loadError': 'Failed to load webhooks',
  'developer.docs.models': 'Public Models',
  'developer.docs.model': 'Model',
  'developer.docs.context': 'Context',
  'developer.docs.capabilities': 'Capabilities',
  'developer.docs.modalities': 'Modalities',
  'developer.docs.pricing': 'Pricing',
  'developer.docs.examples': 'Code Examples',
  'developer.docs.keyPlaceholder': 'Use your API key',
  'developer.docs.endpoints': 'OpenAI-compatible Endpoints',
  'developer.docs.loadError': 'Failed to load models',
  'developer.docs.empty': 'No published models',
  'browser.click': 'Click',
  'browser.clicked': 'Clicked',
  'browser.close': 'Close Session',
  'browser.closed': 'Browser session closed',
  'browser.content': 'Page Content',
  'browser.created': 'Browser session created',
  'browser.evalResult': 'JS Evaluation Result',
  'browser.evaluate': 'Run JS',
  'browser.navigate': 'Navigate',
  'browser.newSession': 'New Session',
  'browser.noContent': 'No content',
  'browser.noEval': 'No JS evaluation yet',
  'browser.noScreenshot': 'No screenshot',
  'browser.screenshot': 'Screenshot',
  'browser.title': 'Browser Agent',
  'browser.type': 'Type',
  'browser.typed': 'Typed',
  'protocol.addServer': 'Add MCP Server',
  'protocol.created': 'MCP server created',
  'protocol.delete': 'Delete',
  'protocol.deleteConfirm': 'Delete this MCP server?',
  'protocol.deleted': 'Deleted',
  'protocol.empty': 'No MCP servers',
  'protocol.namePlaceholder': 'Name, e.g. filesystem',
  'protocol.nameUrlRequired': 'Name and URL are required',
  'protocol.noSync': 'No server synced yet',
  'protocol.sync': 'Sync',
  'protocol.syncResult': 'Sync Result',
  'protocol.synced': 'Synced {{count}} tools',
  'protocol.title': 'Protocol Hub',
  'protocol.urlPlaceholder': 'MCP Server URL, e.g. http://host:port/mcp',
  'stats.dept.activeMemberCount': 'Active Members',
  'stats.dept.description': 'View AI usage of department members (admin: all, dept leader: department, user: self)',
  'stats.dept.memberCount': 'Members',
  'stats.dept.members': 'Member Usage Ranking',
  'stats.dept.models': 'Model Usage Distribution',
  'stats.dept.noData': 'No data',
  'stats.dept.requests': 'requests',
  'stats.dept.searchPlaceholder': 'Search username/nickname',
  'stats.dept.title': 'Department Usage Dashboard',
  'stats.dept.total': 'Total',
  'stats.dept.totalCost': 'Total Cost (USD)',
  'stats.dept.totalTokens': 'Total Tokens',
  'stats.dept.trend': 'Usage Trend (Daily)',
  'stats.member.cost': 'Cost (USD)',
  'stats.member.nickname': 'Nickname',
  'stats.member.requestCount': 'Requests',
  'stats.member.totalTokens': 'Tokens',
  'stats.member.username': 'Username',
  'stats.model.cost': 'Cost (USD)',
  'stats.model.name': 'Model',
  'stats.model.requestCount': 'Requests',
  'stats.model.totalTokens': 'Tokens',
};
